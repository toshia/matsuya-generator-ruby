...
module Matsuya
  ...
  Sample = Set.new([ Menu.new(%i[プレミアム 牛 めし], 380),
                     ...
                     Menu.new(%i[肉 カレー うどん ミニ 牛 めし セット], 680),
                     Menu.new(%i[肉 カレー うどん ミニ ライス セット], 520),
                     Menu.new(%i[ミニ カレー うどん], 200),
                     Menu.new(%i[肉 カレー うどん （プレミアム牛肉使用）], 450),
                     Menu.new(%i[肉 カレー うどん （プレミアム牛肉使用） ミニ プレミアム 牛 めし セット], 770),
                     Menu.new(%i[肉 カレー うどん  （プレミアム牛肉使用） ミニ ライス セット], 520),
                     Menu.new(%i[担々 うどん （関西風だし）], 450),
                     Menu.new(%i[担々 うどん （関西風だし） ミニ 牛 めし セット], 680),
                     Menu.new(%i[担々 うどん], 450),
                     Menu.new(%i[担々 うどん ミニ プレミアム 牛 めし セット], 770),
                     Menu.new(%i[とろ たま うどん （関西風だし）], 410),
                     Menu.new(%i[とろ たま うどん （関西風だし） ミニ 牛 めし セット], 640),
                     Menu.new(%i[とろ たま うどん], 410),
                     Menu.new(%i[とろ たま うどん ミニ プレミアム 牛 めし セット], 730),
                     Menu.new(%i[きつね うどん （関西風だし）], 390),
                     Menu.new(%i[きつね うどん （関西風だし） ミニ 牛 めし セット], 620),
                     Menu.new(%i[きつね うどん], 390),
                     Menu.new(%i[きつね うどん ミニ プレミアム 牛 めし セット], 710),
